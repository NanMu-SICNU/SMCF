...
class Decoder(nn.Module):
    ...
    def forward(self, x1, x2, x3, x4, trans_3, trans_4):
        x4 = self.ppm4(x4*trans_4)
        x3 = torch.cat((x3, self.conv_upsample1(self.upsample(x4))), 1)
        x3 = self.conv_cat1(x3)

        x3 = self.ppm3(x3*trans_3)
...
class SMCF(nn.Module):
    def __init__(self, channel=32):
        ...
        self.reduce_trans3 = DimReduce(1024, channel)
        self.reduce_trans4 = DimReduce(2048, channel)
        ...
        self.CSF1 = CSF(channel)
        self.CSF2 = CSF(channel)
        self.CSF3 = CSF(channel)
        self.CSF4 = CSF(channel)
        ...
        self.group_size = 5
        self.transformer_1 = Transformer(1024, 4, 4, 782, group=self.group_size)
        self.transformer_2 = Transformer(2048, 4, 4, 782, group=self.group_size)
    ...
    def forward(self, x, y):
        ...
        trans_4 = self.transformer_2(m4)

        # ---- feature abstraction ----
        x_s1 = self.reduce_a1(m1)
        x_s2 = self.reduce_a2(m2)
        x_s3 = self.reduce_a3(m3)
        trans_3 = self.reduce_trans3(trans_3)
        x_s4 = self.reduce_a4(m4)
        trans_4 = self.reduce_trans4(trans_4)
        ...
        x_s1, x_s2, x_s3, x_s4, x_e1, x_e2, x_e3, x_e4 = self.CSF1(x_s1, x_s2, x_s3, x_s4, x_e1, x_e2, x_e3, x_e4)
        x_s1, x_s2, x_s3, x_s4, x_e1, x_e2, x_e3, x_e4 = self.CSF2(x_s1, x_s2, x_s3, x_s4, x_e1, x_e2, x_e3, x_e4)
        x_s1, x_s2, x_s3, x_s4, x_e1, x_e2, x_e3, x_e4 = self.CSF3(x_s1, x_s2, x_s3, x_s4, x_e1, x_e2, x_e3, x_e4)
        x_s1, x_s2, x_s3, x_s4, x_e1, x_e2, x_e3, x_e4 = self.CSF4(x_s1, x_s2, x_s3, x_s4, x_e1, x_e2, x_e3, x_e4)

        # ---- feature aggregation using naive u-net ----
        pred_s = self.output_s(x_s1, x_s2, x_s3, x_s4, trans_3, trans_4)
        pred_e = self.output_e(x_e1, x_e2, x_e3, x_e4, trans_3, trans_4)
        ...
        print(pred_s.shape, pred_s[0,0,:,:].shape)
    ...
    def initialize_weights(self):
        ...
        self.resnet.load_state_dict(all_params, strict=True)
